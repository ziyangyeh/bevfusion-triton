...
from . import roiaware_pool3d_legacy_ext as _ext_module
...
def points_in_boxes_gpu(points, boxes):
	...
	assert boxes.shape[2] == 7, (
		f'boxes dimension should be 7, got unexpected shape {boxes.shape[2]}'
	)
	assert points.shape[2] == 3, (
		f'points dimension should be 3, got unexpected shape {points.shape[2]}'
	)
	...
	_ext_module.points_in_boxes_gpu(boxes.contiguous(), points.contiguous(), box_idxs_of_pts)
...
def points_in_boxes_cpu(points, boxes):
	...
	_ext_module.points_in_boxes_cpu(
...
def points_in_boxes_batch(points, boxes):
	...
	_ext_module.points_in_boxes_batch(boxes.contiguous(), points.contiguous(), box_idxs_of_pts)
