...
_EXT_EXPORTED_FUNCTIONS = ['roi_align_forward', 'roi_align_backward']

ext_module = LazyInlineExtension(
	exported_names=_EXT_EXPORTED_FUNCTIONS,
	name='roi_align_ext',
	source_dir=_CSRC_DIR,
	cpp_filenames=['roi_align.cpp', 'roi_align_cpu.cpp'],
	cuda_filenames=['roi_align_cuda.cu'],
...
class RoIAlignFunction(Function):
	...
	def backward(ctx, grad_output):
		...
		rois = rois.to(dtype=grad_output.dtype)
