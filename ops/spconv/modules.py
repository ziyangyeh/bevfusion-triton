...
class SparseSequential(SparseModule):
	...
	To make it easier to understand, given is a small example::
	    ...
	    model = SparseSequential(SparseConv2d(1, 20, 5), nn.ReLU(), SparseConv2d(20, 64, 5), nn.ReLU())
	    ...
	    model = SparseSequential(
	        conv1=SparseConv2d(1, 20, 5), relu1=nn.ReLU(), conv2=SparseConv2d(20, 64, 5), relu2=nn.ReLU()
	    )
	"""
