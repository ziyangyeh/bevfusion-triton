...
_INCLUDE_DIR = _BASE_DIR / 'include'
_CSRC_DIR = _BASE_DIR / 'csrc'
...
verbose = os.getenv('SPCONV_EXT_VERBOSE', '0') == '1'
sparse_conv_ext = LazyInlineExtension(
	exported_names=_EXPORTED_FUNCTIONS,
	name='sparse_conv_ext',
	source_dir=_CSRC_DIR,
	cpp_filenames=_CPP_SOURCES,
	cuda_filenames=_CUDA_SOURCES,
	extra_include_paths=[_INCLUDE_DIR, _CSRC_DIR],
	with_cuda=True,
	verbose=verbose,
)
